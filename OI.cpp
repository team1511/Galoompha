...
#include "Commands/AngleManual.h"
#include "Commands/AngleStatic.h"
#include "Commands/AngletoFeed.h"
...
OI::OI() {
	...
	angleBroken = new JoystickButton(virtualStick, 1);
	angleBroken->WhileHeld(new AngleManual());
	auxStick = new Joystick(3);
	
	shootButton = new JoystickButton(auxStick, 1);
	shootButton->WhileHeld(new ShootDisk());
	feedButton = new JoystickButton(auxStick, 1);
	feedButton->WhileHeld(new AngletoFeed());
	...
	SmartDashboard::PutData("Angle to Feed", new AngletoFeed());
	SmartDashboard::PutData("Angle Static", new AngleStatic());
	SmartDashboard::PutData("Angle Manual", new AngleManual());
